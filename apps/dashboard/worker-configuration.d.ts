/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0210de05f9014f679452f86117dec0c1)
...
interface __BaseEnv_Env {
	...
	ROUTINE_SCHEDULER: DurableObjectNamespace<import("./src/server").RoutineSchedulerAgent>;
	...
	GSC_SYNC_WORKFLOW: Workflow<Parameters<import("./src/server").GscSyncWorkflow['run']>[0]['payload']>;
	SITE_STUDY_WORKFLOW: Workflow<Parameters<import("./src/server").SiteStudyWorkflow['run']>[0]['payload']>;
	COMPETITOR_STUDY_WORKFLOW: Workflow<Parameters<import("./src/server").CompetitorStudyWorkflow['run']>[0]['payload']>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "OnboardingChatAgent" | "SamChatAgent" | "RoutineSchedulerAgent";
	}
