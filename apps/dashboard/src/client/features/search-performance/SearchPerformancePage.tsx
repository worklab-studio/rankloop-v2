...
import { SearchPerformanceMemoryStamp } from "@/client/features/search-performance/SearchPerformanceMemoryStamp";
import {
  DimensionTable,
  exportDimensionRows,
  exportStriking,
      ...
      <div className="mx-auto max-w-7xl space-y-4">
        ...
        {reportQuery.isPending ? (
          ...
          <>
            ...
            <SearchPerformanceMemoryStamp projectId={projectId} />
          </>
        )}
      </div>
    </div>
