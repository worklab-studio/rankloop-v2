...
export const keywordBacklog = sqliteTable(
  "keyword_backlog",
  {
...
export const pageTypes = sqliteTable(
  "page_types",
  {
    id: text("id").primaryKey(),
    projectId: text("project_id")
...
export const pageTypeData = sqliteTable(
  "page_type_data",
  {
    id: text("id").primaryKey(),
...
export const llmSpend = sqliteTable(
  "llm_spend",
  {
...
export const gscSyncRuns = sqliteTable(
  "gsc_sync_runs",
  {
    id: text("id").primaryKey(),
    projectId: text("project_id")
...
export const siteStudyRuns = sqliteTable(
  "site_study_runs",
  {
    id: text("id").primaryKey(),
    projectId: text("project_id")
...
export const writerSettings = sqliteTable("writer_settings", {
  id: text("id").primaryKey(),
  ...
  digestEmail: integer("digest_email", { mode: "boolean" })
    .notNull()
    .default(false),
...
export const autopilotState = sqliteTable("autopilot_state", {
  id: text("id").primaryKey(),
